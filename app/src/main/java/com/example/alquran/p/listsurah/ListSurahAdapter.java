...
public class ListSurahAdapter  extends ListAdapter<Surah, ListSurahAdapter.SurahHolder> {
    ...
    public SurahHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.r_list_surah, parent, false);
